    ...
    def skip_comment(self):
        while self.current_char is not None:
            if self.current_char == '*' and self.peek() == '/':
                ...
                return
            self.advance()
        self.error()  # the closing curly brace
...
class Parser:
    ...
    def formal_parameters(self):
        ...
        for param_token in param_tokens:
            param_node = Param(type_node ,Var(param_token))
    ...
    def type_spec(self):
        ...
        """
        token = self.current_token
        if self.current_token.type == TokenType.DOUBLE:
    ...
    def term(self):
        """term : factor ((MUL | INTEGER_DIV | DIV) factor)*"""
        node = self.factor()
...
class Interpreter(NodeVisitor):
    ...
    def visit_Program(self, node):
        ...
        self.log(f'ENTER: VOID{program_name}')
        ...
        self.log(f'LEAVE: VOID {program_name}')
        self.log(str(self.call_stack))
